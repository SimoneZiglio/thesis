...
set label   2 'MozziandWarrenF(Q)           ' at  0.140E+02, 0.110E+01
...
'C:\EPSR_ESRF\run\sio2x_1\sio2_000.EPSR.t01' u   1:(abs(column(  2))>=1.0e-5?   1.00000*column(  2)+   0.000:1/0) notitle w p ls   1, \
'C:\EPSR_ESRF\run\sio2x_1\sio2_000.EPSR.u01' u   1:(   1.00000*column(  4)+   1.000) notitle w lines ls   2, \
'C:\EPSR_ESRF\run\sio2x_1\sio2_000.EPSR.t01' u   1:(abs(column(  4))>=1.0e-5?   1.00000*column(  4)+   1.000:1/0) notitle w p ls   2
